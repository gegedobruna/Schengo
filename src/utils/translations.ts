...
export const translations = {
  en: {
    ...
    schengenStayTimeline: 'Schengen Stay Timeline',
    rollingWindowVisualization: 'Rolling 180-day window visualization',
    pastStays: 'Past Stays',
    plannedTrip: 'Planned Trip',
    rollingWindow: 'Rolling Window',
    days: 'days',
    planned: 'PLANNED',
    estimated: 'ESTIMATED (to latest safe exit)',
    rollingWindowLabel: '180-day rolling window',
    daysUsedInWindow: '/ 90 days used',
    estimatedTripNoExit: 'Estimated Trip (no exit date)',
  },
  sq: {
    ...
    timelineVisualizer: 'Vizualizuesi i Kohës',
    schengenStayTimeline: 'Koha e Qëndrimit në Schengen',
    rollingWindowVisualization: 'Vizualizimi i dritares rrotulluese 180-ditëshe',
    pastStays: 'Qëndrimet e Kaluara',
    plannedTrip: 'Udhëtimi i Planifikuar',
    rollingWindow: 'Dritarja Rrotulluese',
    days: 'ditë',
    planned: 'I PLANIFIKUAR',
    estimated: 'I VLERËSUAR (deri në daljen më të sigurt)',
    rollingWindowLabel: 'Dritarja rrotulluese 180-ditëshe',
    daysUsedInWindow: '/ 90 ditë të përdorura',
    estimatedTripNoExit: 'Udhëtim i Vlerësuar (pa datë daljeje)',
  }
}

export function useTranslations() {
  const language = ref<Language>('sq')
